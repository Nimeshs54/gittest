...
export CROSS_COMPILE="/usr/bin/ccache $HOME/travis/manu490/GT-I9082_Stock_Kernel/arm-linux-gnueabihf/bin/arm-linux-gnueabihf-" ;
export ARCH=arm;
export SUBARCH=arm;
...
export PATH=$PATH:$HOME/travis/manu490/GT-I9082_Stock_Kernel/arm-linux-gnueabihf/bin ;
make alldefconfig;
make -j$(nproc --all);
